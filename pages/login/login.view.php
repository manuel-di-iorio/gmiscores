<div class="flex items-center justify-center min-h-[calc(100vh-160px)] bg-surface-offset">
  <div class="bg-surface-card shadow-card-prominent rounded-xl p-10 text-center max-w-md w-full">
    <img src="assets/images/logo.svg" alt="Logo" class="max-w-[200px] mb-4 mx-auto dark:hidden">
    <img src="assets/images/logoWhite.svg" alt="Logo" class="max-w-[200px] mb-4 mx-auto hidden dark:block">
