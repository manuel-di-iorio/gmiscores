...
function ui_modal($id, $options = []) {
  ...
  if ($title) {
    $html .= '<div class="flex items-center justify-between px-6 py-4 border-b border-solid border-border-color flex-shrink-0">';
  ...
  if ($footer) {
    $footerClasses = 'flex items-center gap-3 px-6 py-4 border-t border-solid border-border-color flex-shrink-0' . (!empty($options['footer_right']) ? ' justify-end' : '');
