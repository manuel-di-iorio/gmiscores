...
function ui_skeleton($type = 'text', $count = 1, $options = []) {
  $variants = [
    ...
    'table-row' => '<div class="flex gap-4 px-4 py-3 items-center border-b border-solid border-border-color bg-transparent"><div class="ui-skeleton--table-cell h-3 rounded" style="width:6%"></div><div class="ui-skeleton--table-cell h-3 rounded" style="width:22%"></div><div class="ui-skeleton--table-cell h-3 rounded" style="width:16%"></div><div class="ui-skeleton--table-cell h-3 rounded" style="width:14%"></div><div class="ui-skeleton--table-cell h-3 rounded" style="width:18%"></div><div class="ui-skeleton--table-cell h-3 rounded" style="width:8%"></div></div>',
  ];
